...
function vertex_footer_copyright() {
	...
	return '&copy; ' . date_i18n( __( 'Y', 'vertex' ) ) .'. '. __('Powered by <a href="https://wordpress.org" target="_blank">WordPress</a>. Vertex <a href="https://wordpress.org" target="_blank">Dessign</a>','vertex');
