...
<div class="wrap">
	...
	<?php if ( ! get_option( 'catch_instagram_feed_gallery_widget_dismiss' ) ) : ?>
		...
		<div id="cifgw-welcome-panel" class="cifgw-welcome-panel">
			<a class="cifgw-welcome-panel-close button dismiss" href="<?php echo esc_url( menu_page_url( 'catch-instagram-feed-gallery-widget', false ) ); ?>"><?php esc_html_e( 'Dismiss', 'catch-instagram-feed-gallery-widget' ); ?></a>

			<div class="cifgw-welcome-panel-content">
				<div class="cifgw-welcome-panel-column-container">
					<div class="cifgw-welcome-panel-column">
